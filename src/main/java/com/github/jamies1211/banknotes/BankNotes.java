...
import com.github.jamies1211.banknotes.Data.BankNote.CustomDataBuilder;
import com.github.jamies1211.banknotes.Data.BankNote.ImmutableCustomData;
			...
			if (causePlayer.isPresent()) {
				...
				if (optionalItem.isPresent()) {
					...
					if (heldItem.getItem().getName().equalsIgnoreCase("minecraft:paper")) {
						if (heldItem.get(CustomData.class).isPresent()) {
